...
namespace K9.WebApplication.Tests.Unit.Extensions
{
	...
	public class DateTimeExtensionTests
	{
		...
		public void ToHumanReadableString_ShouldDisplayCorrectValue()
		{
            ...
            Assert.AreEqual("Shortly", _shortly.ToHumanReadableString());
            Assert.AreEqual("In 1 minute", _minuteFuture.ToHumanReadableString());
            Assert.AreEqual("In 2 minutes", _2MinutesFuture.ToHumanReadableString());
            Assert.AreEqual("In 59 minutes", _59MinutesFuture.ToHumanReadableString());
            Assert.AreEqual("In 1 hour", _hourFuture.ToHumanReadableString());
            Assert.AreEqual("In 1 hour", _hourFuture59.ToHumanReadableString());
            Assert.AreEqual("In 2 hours", _twoHoursFuture.ToHumanReadableString());
            Assert.AreEqual("In 2 hours", _twoHoursFuture59.ToHumanReadableString());
            Assert.AreEqual("In 23 hours", _23HoursFuture.ToHumanReadableString());
            Assert.AreEqual("Tomorrow", _tomorrow.ToHumanReadableString());
            Assert.AreEqual("Tomorrow", _tomorrow23.ToHumanReadableString());
            Assert.AreEqual("In 2 days", _2DaysFuture.ToHumanReadableString());
            Assert.AreEqual("In 2 days", _2DaysFuture23.ToHumanReadableString());
            Assert.AreEqual("In 6 days", _6DaysFuture23.ToHumanReadableString());
            Assert.AreEqual("In 1 week", _1WeekFuture.ToHumanReadableString());
            Assert.AreEqual("In 8 days", _8DaysFuture.ToHumanReadableString());
            Assert.AreEqual("In 13 days", _13DaysFuture.ToHumanReadableString());
            Assert.AreEqual("In 2 weeks", _2WeeksFuture.ToHumanReadableString());
            Assert.AreEqual("In 15 days", _15DaysFuture.ToHumanReadableString());
            Assert.AreEqual("In 20 days", _20DaysFuture.ToHumanReadableString());
            Assert.AreEqual("In 3 weeks", _3WeeksFuture.ToHumanReadableString());
            Assert.AreEqual("In 1 month", _1MonthFuture.ToHumanReadableString());
            Assert.AreEqual("In 27 days", _27DaysFuture.ToHumanReadableString());
            Assert.AreEqual("In 6 months", _6MonthFuture.ToHumanReadableString());
            Assert.AreEqual("In 11 months", _11MonthFuture.ToHumanReadableString());
            Assert.AreEqual("In 1 year", _1YearFuture.ToHumanReadableString());
            Assert.AreEqual("In 18 months", _18MonthsFuture.ToHumanReadableString());
            Assert.AreEqual("In 18 months", _18MonthsFuture23.ToHumanReadableString());
            Assert.AreEqual("In 2 years", _2YearsFuture.ToHumanReadableString());
            Assert.AreEqual("In 9 years", _9YearsFuture.ToHumanReadableString());
            Assert.AreEqual("In 88 years", _88YearsFuture.ToHumanReadableString());
        }
		...
		public void ToHumanReadableString_ShouldDisplayCorrectValueInFrench()
		{
            ...
            Assert.AreEqual("Tout de suite", _shortly.ToHumanReadableString());
            Assert.AreEqual("Dans 1 minute", _minuteFuture.ToHumanReadableString());
            Assert.AreEqual("Dans 2 minutes", _2MinutesFuture.ToHumanReadableString());
            Assert.AreEqual("Dans 59 minutes", _59MinutesFuture.ToHumanReadableString());
            Assert.AreEqual("Dans 1 heure", _hourFuture.ToHumanReadableString());
            Assert.AreEqual("Dans 1 heure", _hourFuture59.ToHumanReadableString());
            Assert.AreEqual("Dans 2 heures", _twoHoursFuture.ToHumanReadableString());
            Assert.AreEqual("Dans 2 heures", _twoHoursFuture59.ToHumanReadableString());
            Assert.AreEqual("Dans 23 heures", _23HoursFuture.ToHumanReadableString());
            Assert.AreEqual("Demain", _tomorrow.ToHumanReadableString());
            Assert.AreEqual("Demain", _tomorrow23.ToHumanReadableString());
            Assert.AreEqual("Dans 2 jours", _2DaysFuture.ToHumanReadableString());
            Assert.AreEqual("Dans 2 jours", _2DaysFuture23.ToHumanReadableString());
            Assert.AreEqual("Dans 6 jours", _6DaysFuture23.ToHumanReadableString());
            Assert.AreEqual("Dans 1 semaine", _1WeekFuture.ToHumanReadableString());
            Assert.AreEqual("Dans 8 jours", _8DaysFuture.ToHumanReadableString());
            Assert.AreEqual("Dans 13 jours", _13DaysFuture.ToHumanReadableString());
            Assert.AreEqual("Dans 2 semaines", _2WeeksFuture.ToHumanReadableString());
            Assert.AreEqual("Dans 15 jours", _15DaysFuture.ToHumanReadableString());
            Assert.AreEqual("Dans 20 jours", _20DaysFuture.ToHumanReadableString());
            Assert.AreEqual("Dans 3 semaines", _3WeeksFuture.ToHumanReadableString());
            Assert.AreEqual("Dans 1 mois", _1MonthFuture.ToHumanReadableString());
            Assert.AreEqual("Dans 27 jours", _27DaysFuture.ToHumanReadableString());
            Assert.AreEqual("Dans 6 mois", _6MonthFuture.ToHumanReadableString());
            Assert.AreEqual("Dans 11 mois", _11MonthFuture.ToHumanReadableString());
            Assert.AreEqual("Dans 1 an", _1YearFuture.ToHumanReadableString());
            Assert.AreEqual("Dans 18 mois", _18MonthsFuture.ToHumanReadableString());
            Assert.AreEqual("Dans 18 mois", _18MonthsFuture23.ToHumanReadableString());
            Assert.AreEqual("Dans 2 ans", _2YearsFuture.ToHumanReadableString());
            Assert.AreEqual("Dans 9 ans", _9YearsFuture.ToHumanReadableString());
            Assert.AreEqual("Dans 88 ans", _88YearsFuture.ToHumanReadableString());
        }
