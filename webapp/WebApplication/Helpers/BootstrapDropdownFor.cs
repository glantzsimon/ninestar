...
namespace K9.WebApplication.Helpers
{
	public static partial class HtmlHelpers
	{
		...
		{
			return html.DropDownListFor(expression, selectList, null, new { @class = Bootstrap.Classes.SelectList, title = Dictionary.PleaseSelect, data_live_search = liveSearch });
		}
