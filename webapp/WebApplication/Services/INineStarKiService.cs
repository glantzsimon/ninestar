...
namespace K9.WebApplication.Services
{
    public interface INineStarKiService : IBaseService
    {
        ...
        NineStarKiModel CalculateNineStarKiProfile(PersonModel personModel, bool isCompatibility = false, bool isMyProfile = false, DateTime? today = null, bool invertPersonalYinEnergies = true, bool invertCycleYinEnergies = true, bool includeCycles = true, bool useHolograhpicCycleCalculation = false);
